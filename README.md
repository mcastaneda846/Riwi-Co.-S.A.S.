...
DATABASE_URL=postgresql://tu_usuario:tu_contraseña@127.0.0.1:5432/tu_base_de_datos
...
_(Este comando ejecutará la carga idempotente mapeando el archivo `seed.json` en la base de datos activa)._
